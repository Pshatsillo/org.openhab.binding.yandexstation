...
public class YandexStationDiscoveryService extends AbstractDiscoveryService {
    ...
    public static @Nullable List<String> yandexTokenBridgeBusList = new ArrayList<>();

    public YandexStationDiscoveryService() {
        super(Collections.singleton(YandexStationBindingConstants.THING_TYPE_STATION_BRIDGE), 30, false);
    }
    ...
    protected void startScan() {
        ...
        // for (MegaDBridgeIncomingHandler incoming : yandexTokenBridgeBusList) {
